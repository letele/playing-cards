...
const SvgC6 = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      stroke="#000"
    />
    <use xlinkHref="#C-6_svg__a" height={32} width={32} x={-114.4} y={-156} />
    <use
    ...
    <use
      ...
      y={-135.588}
    />
    <use xlinkHref="#C-6_svg__b" height={70} width={70} x={-87.501} y={-35} />
    <use xlinkHref="#C-6_svg__b" height={70} width={70} x={17.501} y={-35} />
